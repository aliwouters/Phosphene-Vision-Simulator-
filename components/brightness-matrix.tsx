...
export function BrightnessMatrix({ matrix, gridRows, gridCols }: BrightnessMatrixProps) {
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <LearnMore step={2}>
        <p>
          Each cell represents the stimulation current delivered by one electrode in
          the cortical implant. Direct electrical stimulation of V1 neurons operates
          between <strong className="text-foreground">2 and 77 microamps</strong> ({'\u03BCA'}).
          Lower currents produce faint, barely perceptible phosphenes, while higher
          currents create brighter, more vivid spots of light. The matrix encodes the
          average luminance of each camera pixel region into a corresponding stimulation
          amperage: dark regions receive minimal current (~2 {'\u03BCA'}) and bright
          regions receive up to 77 {'\u03BCA'}. This current-to-brightness encoding is
          the critical translation step that converts a visual scene into an electrical
