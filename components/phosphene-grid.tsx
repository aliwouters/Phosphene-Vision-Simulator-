...
export function PhospheneGrid({ matrix, gridRows, gridCols }: PhospheneGridProps) {
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <LearnMore step={3}>
        <p>
          This is a simulation of what a visually impaired user with a cortical
          prosthesis would actually perceive. Each glowing dot is
          a <strong className="text-foreground">phosphene</strong>: a spot of light
          produced by electrically stimulating neurons in the primary visual cortex (V1).
          ...
          visual prostheses is to restore functional sight for individuals who are blind
