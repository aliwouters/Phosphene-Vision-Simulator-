...
export function PhospheneGrid({ matrix, gridRows, gridCols }: PhospheneGridProps) {
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <LearnMore>
        <p>
          This represents what a visually impaired user with a cortical prosthesis might
          perceive.           Each dot is a phosphene,
          a point of light generated by stimulating neurons in the V1 area of the
          occipital lobe. Unlike natural vision, phosphene vision consists of discrete
          spots rather than a smooth, continuous image.
        </p>
      </LearnMore>
    </div>
  )
